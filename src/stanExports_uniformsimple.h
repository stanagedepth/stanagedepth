...
namespace model_uniformsimple_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 15, column 4 to column 74)",
                                                      " (in 'string', line 14, column 16 to line 16, column 3)",
                                                      " (in 'string', line 14, column 2 to line 16, column 3)",
...
class model_uniformsimple final : public model_base_crtp<model_uniformsimple> {
private:
  int N;
  Eigen::Matrix<double, -1, 1> depth;
  Eigen::Matrix<double, -1, 1> age;
  Eigen::Matrix<double, -1, 1> age_sd;
 
public:
  ~model_uniformsimple() { }
  
  inline std::string model_name() const final { return "model_uniformsimple"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_uniformsimple(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_uniformsimple_namespace::model_uniformsimple";
    ...
    try {
      ...
      validate_non_negative_index("age_sd", "N", N);
      current_statement__ = 16;
      context__.validate_dims("data initialization","age_sd","double",
          context__.to_vec(N));
      age_sd = Eigen::Matrix<double, -1, 1>(N);
      stan::math::fill(age_sd, std::numeric_limits<double>::quiet_NaN());
      
      {
        std::vector<local_scalar_t__> age_sd_flat__;
        current_statement__ = 16;
        assign(age_sd_flat__, nil_index_list(), context__.vals_r("age_sd"),
          "assigning variable age_sd_flat__");
        current_statement__ = 16;
        pos__ = 1;
        current_statement__ = 16;
        for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
          current_statement__ = 16;
          assign(age_sd, cons_list(index_uni(sym1__), nil_index_list()),
            age_sd_flat__[(pos__ - 1)], "assigning variable age_sd");
          current_statement__ = 16;
          pos__ = (pos__ + 1);}
      }
      current_statement__ = 17;
      validate_non_negative_index("modelled_age", "N", N);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_uniformsimple_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      modelled_age = Eigen::Matrix<local_scalar_t__, -1, 1>(N);
      ...
      check_ordered(function__, "modelled_age", modelled_age);
      {
        ...
        lp_accum__.add(
          normal_lpdf<propto__>(first_age, age[(1 - 1)], age_sd[(1 - 1)]));
        current_statement__ = 9;
        lp_accum__.add(normal_lpdf<propto__>(age, modelled_age, age_sd));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_uniformsimple_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      modelled_age = Eigen::Matrix<double, -1, 1>(N);
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"rate\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"first_age\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"modelled_age\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_uniformsimple_namespace::model_uniformsimple;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_uniformsimple_namespace::profiles__;
}
#endif
#endif
