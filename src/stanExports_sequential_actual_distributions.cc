...
#include "stanExports_sequential_actual_distributions.h"

RCPP_MODULE(stan_fit4sequential_actual_distributions_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_sequential_actual_distributions")
