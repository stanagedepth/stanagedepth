...
#include "stanExports_sequential_simple.h"

RCPP_MODULE(stan_fit4sequential_simple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_sequential_simple")
